...
public final class TetheredClient implements Parcelable {
    @NonNull private final MacAddress mMacAddress;
    @NonNull private final List<AddressInfo> mAddresses;
    // TODO: use an @IntDef here
    private final int mTetheringType;

    public TetheredClient(
            @NonNull MacAddress macAddress,
            @NonNull Collection<AddressInfo> addresses,
            int tetheringType) {
    ...
    @NonNull public List<AddressInfo> getAddresses() {
    ...
    public TetheredClient addAddresses(@NonNull TetheredClient other) {
        final LinkedHashSet<AddressInfo> newAddresses =
                new LinkedHashSet<>(mAddresses.size() + other.mAddresses.size());
    ...
    public static final class AddressInfo implements Parcelable {
        @NonNull private final LinkAddress mAddress;
        @Nullable private final String mHostname;
         ...
         *
         * <p>This may be an IPv4 or IPv6 address.
         */
        @NonNull public LinkAddress getAddress() {
            return mAddress;
        }
        ...
        public boolean equals(@Nullable Object obj) {
            ...
            // should be included.
            return other.mAddress.equals(mAddress) && Objects.equals(mHostname, other.mHostname);
        }

        @NonNull public static final Creator<AddressInfo> CREATOR =
    ...
    @NonNull public static final Creator<TetheredClient> CREATOR =
            new Creator<TetheredClient>() {
                @NonNull @Override
